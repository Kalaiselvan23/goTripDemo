            ...
            <div className="backdrop-brightness-50 h-full w-full flex justify-center items-center">
                <div className="grid grid-cols-[30rem_auto] grid-rows-1 h-3/4 w-3/5 rounded-xl max-md:grid-cols-1 max-md:w-4/5">
                    <div className="rounded-2xl max-md:hidden">
                        <img src="/assets/signup.jpg" className="w-full h-full rounded-s-xl" alt="loginbg" />
                    </div>
                    <div className="backdrop-blur-2xl bg-white p-4 pt-10 rounded-e-xl flex flex-col justify-center">
                        <div className="w-48 mx-auto">
                            <img src="/assets/logo.png" alt="logo" />
                        </div>
                        <label className="login-inputs">
                          <span>Name</span>
                          <input placeholder="Enter Name" className="border-2" />
                        </label>
                        <label className="login-inputs">
                            <span>Email</span>
                            <input placeholder="Enter Email" className="border-2" />
                        </label>
                        <label className="login-inputs">
                            <span>Password</span>
                        ...
                        <div className="flex justify-center items-center gap-3">
                            ...
                            <p className="text-blue-500">Already a user?<Link className="underline" to={"/login"}>Login</Link></p>
                        </div>
                    </div>
                </div>
            </div>
